 ...
 */
bool Graph::addEdge(int eid, int sourceId, int destId, double weight/*, Road *w*/, bool accidented) {
	return addEdge(eid, findVertex(sourceId), findVertex(destId),weight/*, w*/);
}
 ...
 * @throws logic_error if Repeated edge id
 */
bool Graph::addEdge(int eid, Vertex* vsource, Vertex* vdest, double weight/*, Road *w*/, bool accidented) {
